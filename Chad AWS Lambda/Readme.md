...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Chad AWS Lambda*):
...
Execute unit tests
```
    cd "Chad AWS Lambda/test/Chad AWS Lambda.Tests"
    dotnet test
```

Deploy application
```
    cd "Chad AWS Lambda/src/Chad AWS Lambda"
